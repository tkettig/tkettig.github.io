...
1. We've seen that overall, people report being quite familiar with the SSBE accent: The mode of the distribution when plotting the histogram of SSBEFamiliarity scores was the highest bin (97-100). Is this also true for familiarity with Newcastle and Middlesbrough accents? Plot the histograms to find out.
