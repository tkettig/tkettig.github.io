...
Go to eClass and download the zip file __"Lab5_Soundfiles"__, containing the following files. Note, you can also generate these yourself; I have done it for you here to make sure that the sound files are clear enough for taking measurements.
...
1. Open the file __"Lab5_Wi_Ju.wav"__. Follow the instructions below and fill in Table 5.1 on the acoustic correlates of different glides.  
