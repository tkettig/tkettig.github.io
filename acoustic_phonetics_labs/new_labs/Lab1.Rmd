...
3. Record the sentence - __“My name is [first-name] [last-name]”__. In the main menu of the Objects window (see Figure 1.2):
...
<font size= "4.5"> <br>
On eClass, submit a PDF with your answers to the following questions and also submit the .wav and .TextGrid files that you created for this lab. Each student must complete and submit this lab on their own.
