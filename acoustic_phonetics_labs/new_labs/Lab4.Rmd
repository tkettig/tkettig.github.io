...
>__TIP:__  
The fundamental frequency value is always displayed on the <u>right</u> side of the window in dark red (or dark blue, on older versions of Praat); formant frequencies are displayed on the <u>left</u> side in red – be careful not to get these two confused!
>
You can get Praat to place the cursor at the nearest zero-crossing by using the shortcut __Ctrl-0__ (zero), or __Command-0__ on a Mac. Additionally, if you highlight a section of a waveform, the shortcuts __Ctrl/Command-__, and __Command-__. will move the left and right edges of the selection to the closest zero-crossing.
>
