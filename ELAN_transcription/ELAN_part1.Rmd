...
You have been assigned a section of the interview that's under 5 minutes long. Finish the segmentation of all three speakers in your assigned section and submit it with your Homework 1. Ideally, your segments should be present whenever the speaker on that tier is making noise. After fully segmenting who is speaking when, your file will look something like this:
