...
Generate a single sound file, __"Lab4_SourceFilter.wav"__, containing the vowel [ɛ] produced at three different pitches: low, mid & high. When recording this, try to get the biggest range in pitch you can (if you can’t remember how to record yourself, refer to Lab 1).
...
>__TIP:__  
The fundamental frequency value is always displayed on the <u>right</u> side of the window in dark blue; formant frequencies are displayed on the <u>left</u> side in red – be careful not to get these two confused!
>
