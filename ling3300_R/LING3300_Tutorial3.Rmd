...
### Load in the dataset
```{r eval = FALSE}
mcm <- read.csv("/Users/Thomas/Documents/York (Canada)/LING 3300/Datasets/Jury/jury_data_basic.csv", header = TRUE)
View(mcm)
```
...
One of the main (best) packages for **data visualization in R** is the ggplot2 package. This package is also part of the tidyverse suite of packages, and is commonly referred to as "ggplot". You can read more about the background to ggplot2 [here](https://qz.com/1007328/all-hail-ggplot2-the-code-powering-all-those-excellent-charts-is-10-years-old/). 
...
A little more on this can be found [here] (https://ggplot2.tidyverse.org/). 

### Getting set up
First, you'll need to install the package and load it into your current library of packages. 
```{r eval = F}
...
```{r eval = T}
mcm <- read.csv("C:/Users/ep1290/OneDrive - University of York/Desktop/QM/QM_Datasets/McMurrayJongmanFricativeAcoustics.csv", header = TRUE)
```
